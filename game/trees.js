...
Tree.prototype.destroy = function() {
    ...
    // the first splice parameter is the position from which the delete begins
    // second parameter - the number of elements to remove from the array
    // the construction with indexOf (this) allows you to delete exactly the object that leaves the scene
