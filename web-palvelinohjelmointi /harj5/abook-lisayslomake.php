...
function teeMuokkauslomake($stmt)
{
  ...
  $forms = <<<FORMEND
  <em>Lisätä osoitetta</em>
  <form method='post' action='abook-lisaa.php'>
    <table border='0' cellpadding='5'>
      <tr valign='top'>
        <td align='right' bgcolor='#ffeedd'>Tunnus</td>
        <td bgcolor='#dddddd'><input type='text' name='tunnus' size='30' value='{$row['tunnus']}'></td>
      </tr>
      <tr valign='top'>
    ...
    <br>
    <input type='submit' name='action' value='Lisaa' onclick="javascript: return confirm('Lisaa osoitteet?')">
  </form>
FORMEND;
